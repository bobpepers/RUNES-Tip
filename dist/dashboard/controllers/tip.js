...
exports.fetchTips = exports.fetchTip = void 0;
...
var fetchTips = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            res.locals.name = 'tip';
            _context.next = 4;
            return _models["default"].tip.count(options);

          case 4:
            res.locals.count = _context.sent;
            _context.next = 7;
            return _models["default"].tip.findAll(options);
  ...
  return function fetchTips(_x, _x2, _x3) {
...
var fetchTip = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            res.locals.name = 'tip';
            _context2.next = 4;
            return _models["default"].tip.findOne(options);
  ...
  return function fetchTip(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.fetchTip = fetchTip;