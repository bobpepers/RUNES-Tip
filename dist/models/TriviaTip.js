...
module.exports = function (sequelize, DataTypes) {
  ...
  var TriviaTipModel = sequelize.define('triviatip', modelDefinition, modelOptions); // 4: Wallet belongs to User

  TriviaTipModel.associate = function (model) {
    ...
    TriviaTipModel.hasMany(model.activity, {
      as: 'triviatip'
    });
