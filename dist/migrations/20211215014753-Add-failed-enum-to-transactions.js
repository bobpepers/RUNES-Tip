      ...
      return _regenerator["default"].wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return queryInterface.changeColumn('transaction', 'phase', {
                type: DataTypes.ENUM('review', 'pending', 'confirming', 'confirmed', 'rejected', 'failed')
              });
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return queryInterface.changeColumn('transaction', 'phase', {
                type: DataTypes.ENUM('review', 'pending', 'confirming', 'confirmed', 'rejected')
              });
